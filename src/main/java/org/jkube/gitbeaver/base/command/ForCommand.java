...
public class ForCommand extends AbstractCommand {
    ...
    public enum ForType {
        FILE, FOLDER, SUBFOLDER, LINE, SUBSTRING
    }
    ...
    private static final String SUBSTRINGVAR = "substringvar";
    ...
    public ForCommand() {
        ...
        commandlineVariant("FOR SUBSTRING "+SUBSTRINGVAR+" IN "+STRINGVALUE+" SPLIT ON "+SEPARATOR+" "+REST, "Execute the command for all comma separated pieces of specified string");
    ...
    public void execute(Map<String, String> variables, WorkSpace workSpace, Map<String, String> arguments) {
        ...
        if (arguments.containsKey(LINEVAR)) {
            ...
            variable = null;
            type = null;
            Application.fail("Unexpected case");
        }
        ...
        List<String> items = switch (type) {
            ...
            case SUBSTRING -> splitItemsInString(stringvalue, separatorvalue);
        };
