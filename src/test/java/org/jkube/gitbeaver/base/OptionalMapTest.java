...
public class OptionalMapTest extends GitBeaverAbstractTest {

    private static final String TEST_PATH_PREFIX = "src/test/resources/optional_map_test_";
    ...
    @Test
    void optionalMapTest1() {
        runTest(Path.of(TEST_PATH_PREFIX+1));
    }
    @Test
    void optionalMapTest2() {
