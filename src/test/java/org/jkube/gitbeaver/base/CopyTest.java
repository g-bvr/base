...
public class CopyTest extends GitBeaverAbstractTest {

    private static final String TEST_PATH_PREFIX = "src/test/resources/copy_test_";
    ...
    @Test
    void copyTest3() {
        runTest(Path.of(TEST_PATH_PREFIX+3));
    }

    @Test
    void copyTest4() {
        runTest(Path.of(TEST_PATH_PREFIX+4));
    }
